...
| --- | --- | --- |
| `--branch` | build.sh | Select the MBL branch to build. For example, to build the branch `mbl-os-0.8`: <br>`./mbl-tools/build-mbl/run-me.sh -- --branch mbl-os-0.8 --machine raspberrypi3-mbl` |
