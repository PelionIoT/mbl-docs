...
* Python code:
  ...
  * Automated check scripts in our `mbl-tools` repository: [https://github.com/ARMmbed/mbl-tools/tree/mbl-os-0.9/ci/sanity-check](https://github.com/ARMmbed/mbl-tools/tree/mbl-os-0.9/ci/sanity-check).
