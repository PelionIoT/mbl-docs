...
```
./mbl-tools/build-mbl/run-me.sh --builddir ./build-warp7 -- --machine imx7s-warp-mbl --branch mbl-os-0.7 --url git@github.com:your-github-account/mbl-manifest.git
```
...
1. To run build-mbl in interactive mode (change parameters for `--builddir` and `--machine` as needed):
    ...
    ```
    ./mbl-tools/build-mbl/run-me.sh --builddir ./build-warp7 -- --branch mbl-os-0.7 --machine imx7s-warp-mbl interactive
    ```
...
```
./mbl-tools/build-mbl/run-me.sh --builddir ./build-warp7 -- --branch mbl-os-0.7 --machine imx7s-warp-mbl build
```
...
```
./mbl-tools/build-mbl/run-me.sh --builddir ./build-warp7 -- --branch mbl-os-0.7 --machine imx7s-warp-mbl sync
```
